...
:::::: {.grid .gap-3}
::: {.g-col-12 .g-col-md-4}
![*Heat wave simulation chambers setup in the greenhouse*](./preview-image.jpg){.lightbox fig-cap="Caption 1" width="100%"}
:::

::: {.g-col-12 .g-col-md-4}
![*Video feed of bumble bee microcolony with ArUco tagged workers*](./bees.jpg){.lightbox fig-cap="Caption 2" width="100%"}
:::

::: {.g-col-12 .g-col-md-4}
![*Tagged plants inside the treatment chambers*](./plants.jpg){.lightbox fig-cap="Caption 3" width="100%"}
:::
::::::

<iframe src="https://www.youtube.com/embed/dEBrNpuV8Wo" width="100%" height="400" frameborder="0" allowfullscreen>
