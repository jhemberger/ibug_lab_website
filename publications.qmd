...
title: "Publications"
listing: 
  contents: "publications/*/index.qmd" # this name must match the name of the folder you created in step #1; here, all Quarto docs in the `posts` directory will be included on your listing page
